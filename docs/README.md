...
Complete documentation for anyclaude - the translation layer enabling Claude Code with local LMStudio models.
...
- [Trace Tool Calls](debugging/trace-tool-calls.md) - Capturing tool events
- [Capture Tool Calls](debugging/capture-tool-calls.md) - Recording for analysis
- [Tool Comparison Report](debugging/tool-comparison-report.md) - Claude vs LMStudio comparison
