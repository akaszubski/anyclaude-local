...
Expected: Model _should_ call Bash tool with `git status` but might respond with text instead
...
Expected: Model _should_ call Read tool, but may struggle or give "Invalid tool parameters"
