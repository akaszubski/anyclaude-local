...
echo "━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━"
echo ""
echo "Starting anyclaude with ANYCLAUDE_DEBUG=1..."
echo "We'll send a simple prompt: 'Say hello in one sentence'"
echo ""

# Start anyclaude in background, send a simple message, then exit
(
  sleep 2
  echo "Say hello in one sentence"
  sleep 10
  echo "exit"
) | ANYCLAUDE_DEBUG=1 anyclaude --mode=lmstudio > /tmp/anyclaude-demo.log 2>&1 &
ANYCLAUDE_PID=$!
...
trace-analyzer analyze "$TRACE_FILE"
...
trace-replayer replay "$TRACE_FILE"
...
echo "  2. Run: trace-replayer replay $TRACE_FILE"
echo "  3. Repeat for each model you want to test"
echo "  4. Run: trace-replayer compare ./trace-replays/"
echo ""
