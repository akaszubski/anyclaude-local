...
test(
  "Gemini 2.5 Flash Lite returns 1M context",
  1048576,
...
test(
  "DeepSeek V3.1 returns 160K context",
  163840,
...
test(
  "Claude 3.5 Sonnet returns 200K context",
  200000,
  "anthropic/claude-3.5-sonnet"
);
test(
  "Llama 3.3 70B returns 128K context",
  131072,
...
console.log("\n--- Claude Model Names ---");
test(
  "Claude Sonnet 4.5 returns 200K context",
  200000,
  "claude-sonnet-4-5-20250929"
);
test(
  "Claude Haiku 4.5 returns 200K context",
  200000,
